				...
				<div className=" d-flex justify-content-center m-5">
					<form className="w-100 p-3" onSubmit={formik.handleSubmit}>
						<div className="col-md-4">
							...
							<input
								type="text"
								className={`form-control ${formik.touched.fname && formik.errors.fname
						...
						<div className="col-md-4">
							...
							<input
								type="text"
								className={`form-control ${formik.touched.lname && formik.errors.lname
									? "border-danger border-3"
									: "border-secondary-subtle border-1"
									}`}
								id="lname"
						...
						<div className="col-md-4">
							...
							<input
								type="text"
								className={`form-control ${formik.touched.contactNum && formik.errors.contactNum
									? "border-danger border-3"
									: "border-secondary-subtle border-1"
									}`}
								id="contactNum"
